                ...
                <Grid as fullWidth let:props>
                    <TabContent {...props}>
                        <Row>
                            <Column md={4} lg={7}>
                                ...
                                <p>
                                    Carbon is IBM’s open-source design system for digital products and experiences. With
                                    the IBM Design Language as its foundation, the system consists of working code,
                                    design tools and resources, human interface guidelines, and a vibrant community of
                                    contributors.
                                </p>
                            </Column>
                        </Row>
                    ...
                    <TabContent {...props}>
                        <Row>
                            <Column md={4} lg={7}>
                                <p>
                                    Carbon provides styles and components in Vanilla, React, Angular, Vue and Svelte for
